...
Pipeline::~Pipeline() {
  // Note: destroy() should be called explicitly because we need the VkDevice
  // handle
}

void Pipeline::init(const Render::Context &context,
  ...
  vInput.vertexAttributeDescriptionCount =
